...
public class BeanDefinitionParserDelegate {
	 ...
	 * if there were errors during parse. Errors are reported to tProblemReporterhe
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, @Nullable BeanDefinition containingBean) {
		...
		String beanName = id;
		// 未设置beanId,但是设置了beanName,取第一个别名为bean的Id.
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		try {
			...
			// class description parse eg: <description>testDescription<description/>
			bd.setDescription(DomUtils.getChildElementValueByTagName(ele, DESCRIPTION_ELEMENT));

			// parse meta ele(bean's child ele)
	 ...
	 * @param containingBean containing bean definition 父类
	 * @return a bean definition initialized according to the bean element attributes
	 */
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
																@Nullable BeanDefinition containingBean, AbstractBeanDefinition bd) {
        // 单例多例标签 仅仅在1.x版本使用，目前已经是用scope代替了
